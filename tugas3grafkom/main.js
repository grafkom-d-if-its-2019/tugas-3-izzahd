...
function initBuffers() {
    ...
    NVertexPositionBuffer.numItems = 72
    // Triangle Color
    ...
    // front and back
    for (let i = 0; i < 24; i++) {
        colors = colors.concat([0.0, 0.5, 0.5, 1.0])
    }

    // outer 1
    for (let i = 0; i < 16; i++) {
        colors = colors.concat([0.0, 0.25, 0.25, 1.0])
    }

    // outer 2
    for (let i = 0; i < 16; i++) {
        colors = colors.concat([0.0, 0.15, 0.15, 1.0])
    }
    ...
    NVertexColorBuffer.numItems = 72
    ...
    NVertexIndexBuffer.numItems = 108
